...
//  InstagramUI
//
//  Created by Adam Kouhel on 12/11/17.
...
class NewsfeedTableViewController: UITableViewController {
    ...
    struct Storyboard {
        ...
        static let postHeader = "PostHeader"
...
extension NewsfeedTableViewController {
    ...
    override func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        let cell = tableView.dequeueReusableCell(withIdentifier: Storyboard.postHeader) as! PostHeader
